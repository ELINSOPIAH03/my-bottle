...
export default function Footer() {
    return(
        <div className="px-6 pt-16 mx-auto md:px-24 lg:px-20 bg-white">
            <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
                <div className="sm:col-span-2">
                    <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
                        ...
                        <span className="ml-2 text-xl font-bold tracking-wide text-baseblue-500 uppercase">My Bottle</span>
                    </a>
                ...
                <div className="space-y-2 text-sm">
                    <p className="text-base font-bold tracking-wide text-baseblue-500">Contacts</p>
                    <div className="flex">
                ...
                <div>
                    <span className="text-base font-bold tracking-wide text-baseblue-500">Social</span>
                    <div className="flex items-center mt-1 space-x-3">
                        <a href="/" className="text-baseblue-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
                    ...
                    <p className="mt-4 text-sm text-baseblue-500">
                        Lorem ipsum dolor amet short ribs pig sausage prosciutto chicken spare ribs salami.
                    </p>
                </div>
            </div>
